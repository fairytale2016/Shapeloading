...
public class ShapeLoadingDialog {
    ...
    private  DlalogCancelListener celListener;
    ...
    private void init() {
        ...
        mDialog.setOnCancelListener(new OnCancelListener() {
			...
			public void onCancel(DialogInterface dialog) {
				celListener.onMyCancel(mDialog);
			}
		});
    }
    ...
    public void setCanceledOnBackKey(boolean cancel){
    	mDialog.setCancelable(cancel);
    }
    
    public void setOnCancelListener(final DlalogCancelListener CancelListener){
    	celListener = CancelListener;
    }
    
    public interface DlalogCancelListener{
